            ...
            <form className="login-form">
                <div className="login-form-group">
                    <div className="login-form-subgroup">
                        ...
                        <br/>
                        <input onChange={event => updateName(event.target.value)} type="name" placeholder="Type your name here" className="input-field"></input>
                    </div>
                    <br/>
                </div>
                <br/>
                <div className="login-form-group">
                    ...
                    <div className="login-form-subgroup">
                        ...
                        <br/>
                        <input onChange={event => updatePhone(event.target.value)} type="tel" placeholder="Enter Phone Number" className="input-field"></input>
                    </div>
                    <br/>
                </div>
                <br/>
                <div className="login-form-group">
                    ...
                    <div className="login-form-subgroup">
                        ...
                        <br/>
                        <input onChange={event => updateConfirmPassword(event.target.value)} type="password" className="input-field" placeholder="6+ characters"></input>
                    </div>
                    <br/>
                </div>
                <br/><br/>
                <div className="login-form-group">
                    <button onClick={validate} className="form-btn form-submit-btn">Sign Up</button>
                </div>
            </form>
        </div>
    );
